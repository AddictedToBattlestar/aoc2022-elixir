defmodule Day5.Part2SupplyStackBuilder do
  def new(lineData) do
...
defmodule Day5.Part2SupplyStackProcessor do
...
defmodule Day5.Part2 do
  def processStackChangesAndFindTopCrates() do
    ...
    stackDataTracker = Day5.Part2SupplyStackBuilder.new(lineData)
    ...
    resultingStackDataTracker = Enum.reduce(messages, stackDataTracker, fn(message, currentStackDataTracker) ->
      IO.puts(message)
      parsedMessage = Day5.Part2SupplyStackProcessor.parseStackChangeMessage(message)
      resultingStackDataTracker = Day5.Part2SupplyStackProcessor.moveCrates(currentStackDataTracker, parsedMessage)
      IO.inspect(resultingStackDataTracker)
      resultingStackDataTracker
    end)

    Day5.Part2SupplyStackProcessor.findTopCratesFromStacks(resultingStackDataTracker)
  end
